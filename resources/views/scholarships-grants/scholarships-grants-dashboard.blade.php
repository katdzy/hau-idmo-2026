            ...
            <div class="w-[95%] flex flex-col bg-white rounded-lg px-8 py-8">
                ...
                <div class="w-full flex gap-12">
                    ...
                    <section class="flex flex-col mt-2">
                        <h1 class="text-gray-500 text-[1.7rem] font-bold">Scholarships</h1>
                        <div class="w-full flex py-1 gap-2">
                            <a class="maroon bg-red-900 text-white rounded-[25px] px-12 py-8 font-semibold flex flex-col items-center justify-center" href="{{ route('dashboard') }}">
                    ...
                    <!-- Education Tools -->
                    <section class="flex flex-col mt-2">
                        <h1 class="text-gray-500 text-[1.7rem] font-bold">Sample</h1>
                        <div class="w-full flex py-1 gap-2">
                            <a class="maroon bg-red-900 text-white rounded-[25px] px-12 py-8 font-semibold flex flex-col items-center justify-center" href="{{ route('dashboard') }}">
                ...
                <div class="w-full flex gap-12 mt-4">
                    <!-- Issuance Tools -->
                    <section class="flex flex-col mt-2">
                        <h1 class="text-gray-500 text-[1.7rem] font-bold">Grants</h1>
                        <div class="w-full flex py-1 gap-2">
                            <a class="maroon bg-red-900 text-white rounded-[25px] px-12 py-8 font-semibold flex flex-col items-center justify-center" href="{{ route('dashboard') }}">
