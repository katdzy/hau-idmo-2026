...
<x-app-layout>
    ...
    <div class="box-card">
        ...
        <div class="box-title">
            ...
            <h1> {{$data-> fname . ' ' . $data-> mname . ' ' . $data-> lname}}</h1> 
        </div>
        ...
        <div class="box-body">
            <div class="w-2/3 grid grid-cols-2 gap-2">
                ...
                <div class="form-col">
                    ...
                    <h1> {{$data->date_of_birth}} </> 
                </div>

                <div class="form-col">
                    <span> Relationship </span> 
                    <h1> {{$data->relationship}} </> 
                </div>
            </div>
                ...
                <div class="form-row grid2">
                    ...
                    <div class="file-attachment">
                        ...
                        <a href = "{{asset('storage/dependents/'.  $user->emp_id.  '/' . $data->id . '.' . explode('.', $data->attachment)[1])}}" download> {{$data -> attachment}}</a>
                    </div>
                    </div>
                </div>
                ...
                <iframe id="pdfIframe" src="{{asset('storage/dependents/'.  $user->emp_id.  '/' . $data->id . '.' . explode('.', $data->attachment)[1])}}" width="100%" height= "500px" ></iframe>
