    ...
    <div class="min-h-screen">
        <div class="w-full flex justify-center py-8">
            <div class="w-[95%] flex flex-col p-8 rounded-lg bg-white items-start">
                ...
                <a href="{{ route('portal.filing.edu-bg') }}" class="flex justify-center items-center bg-gray-500 hover:bg-gray-400 text-white rounded-lg px-8 py-1 gap-2 mb-4">
                    ...
                    @else
                        <div class="w-full flex flex-col overflow-y-auto h-[300px]">
                            @foreach($approved as $item)
                                <div class="w-full grid grid-cols-[10%_10%_20%_35%_15%_10%] p-4 border-t border-gray-200 bg-white hover:bg-gray-50 transition-colors">
                                    ...
                                    <div class="w-full flex justify-center">
                                        <form action="{{ route('portal.edu-bg.view', ['id' => $item->id]) }}" method="GET" class="w-full">
