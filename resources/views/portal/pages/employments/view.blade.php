...
<!-- resources\views\portal\pages\employments\view.blade.php -->
<x-app-layout>
                ...
                <div class="w-full grid grid-cols-3 gap-2">
                    ...
                    <div class="flex flex-col leading-tight">
                        ...
                        <div class="flex items-center overflow-hidden">
                            ...
                            @if(isset($approval)) 
                            <a class ="text-blue-400 hover:text-blue-600 text-decoration-line: underline" href = "{{asset('storage/employment/' .$user->emp_id . '/'. $file) }}" download> {{$data -> attachment}}</a>
                            @else
                            <a class ="text-blue-400 hover:text-blue-600 text-decoration-line: underline" href = "{{asset('storage/employment/' . Auth::user()->id. '/'. $file)  }}" download> {{$data -> attachment}}</a>
                            @endif
                        </div>
                    </div>
