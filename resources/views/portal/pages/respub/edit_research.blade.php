            ...
            <div class="box-card">
                <div class="box-title">
                    <div class="left">
                        ...
                        <div class="rtitle">
                            <h1> Research - Resubmit Form</h1>
                        </div>
                        @else
                        <div class="rtitle">
                            <h1> Research - Edit Form</h1>
                        </div>
                        @endif
                    </div>
                    <div class="right">
                ...
                <div class="box-body">
                    <form action="{{ route('portal.respub.update', ['id' => $data->id]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row" style="margin-bottom: 1rem;">
                            <div class="form-col">
                                <span style="font-weight: 500;"> Title <span class="font-bold text-red-500">*</span></span>
                        ...
                        <div class="form-row desc" style="margin-bottom: 1rem;">
                            <div class="form-col">
                                <span style="font-weight: 500;"> Description <span class="font-bold text-red-500">*</span></span>
                        ...
                        <div class="form-row grid" style="margin-bottom: 1rem;">
                            <div class="form-col" style="margin-right:1rem;">
                                <span style="font-weight: 500;"> Author <span class="font-bold text-red-500">*</span></span>
