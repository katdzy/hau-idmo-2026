        ...
        <div class="container">
            <div class="success-box">
                <div class="success-card">
                    <div class="sc-icon"><img src = "{{asset('images/icons/success.png')}}"/> </div>
                    <div class="sc-title">
                        <h1> Submission Successful!
                        </h1> 
                    </div>
                    <div class="sc-msg">
                        <h3> Thank you for your submission. Your entry is currently under review. Please allow some time for our team to verify the information.</h3>
